...
const CashBankReport: React.FC = () => {
  ...
  const getSampleData = (): CashBankReportData[] => {
    ...
    return [
      {
        ...
        account_name: 'Банковские счета рублевые',
        ...
        children: [
          {
            ...
            account_name: 'Маркова-Дорей Ю.В. ИП',
      ...
      <React.Fragment key={item.id}>
        <tr className={`hover:bg-gray-50 dark:hover:bg-dark-700 transition-colors ${
          ...
          <td className="px-6 py-3 text-sm text-gray-900 dark:text-white">
            {item.account_name !== item.organization_name ? item.account_name : ''}
          </td>
