...
const PlanFactRevenueReport: React.FC = () => {
  ...
  const getSampleData = (): PlanFactRevenueData[] => {
    ...
    const uuid16 = generateUUID()
    const uuid17 = generateUUID()
    const uuid18 = generateUUID()
    const uuid19 = generateUUID()
    const uuid20 = generateUUID()
    const uuid21 = generateUUID()
    const uuid22 = generateUUID()
    const uuid23 = generateUUID()
    const uuid24 = generateUUID()
    const uuid25 = generateUUID()
    const uuid26 = generateUUID()
    const uuid27 = generateUUID()
    const uuid28 = generateUUID()
    const uuid29 = generateUUID()
    const uuid30 = generateUUID()
