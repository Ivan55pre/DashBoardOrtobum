  ...
  const loadCashBankData = async () => {
    try {
      ...
      return {
        ...
        change: 5.2 // Демо-значение для изменения
      }
    } catch (error) {
  ...
  const loadDebtData = async () => {
    try {
      ...
      return {
        ...
        change: -2.1 // Демо-значение для изменения
      }
    } catch (error) {
  ...
  const loadInventoryData = async () => {
    try {
      ...
      return {
        ...
        change: 16.42 // Демо-значение для изменения
      }
    } catch (error) {
  ...
  const loadPlanFactData = async () => {
    try {
      ...
      return {
        ...
        change: -8.1 // Демо-значение для изменения
      }
    } catch (error) {
